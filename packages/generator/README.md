...
1. Irregular albums, such as splits & comps, must be housed in underscore-prefixed directories, e.g. `_SPLITS` and `_COMPS`, and must follow this structure: `_DIR/album-slug/track-number_artist-slug_track-slug.mp3`
